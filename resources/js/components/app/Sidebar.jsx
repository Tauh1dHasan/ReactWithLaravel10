                    ...
                    <div id="scrollbar">
                        <div className="container-fluid">
                            ...
                            <ul className="navbar-nav" id="navbar-nav">
                                ...
                                <li className="nav-item">
                                    <Link to="/blank-page" className="nav-link menu-link" >
                                        <i className="ri-dashboard-2-line"></i> <span data-key="t-ecommerce">Blank Page</span>
                                    </Link>
                                </li>
                                ...
                                <li className="nav-item">
                                    <a className="nav-link menu-link" href="#sidebarMultilevel" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarMultilevel">
                                        <i className="ri-share-line"></i> <span data-key="t-multi-level">Multi Level Sample</span>
                                    </a>
